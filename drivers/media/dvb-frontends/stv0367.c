 ...
 *
 * Support for DigitalDevices CineCTv6 and DuoFlex C/T port
 * (ported from Digital Devices vendor driver package)
 * Copyright (C) 2017 Daniel Scheller <d.scheller.oss@gmail.com>
 *
